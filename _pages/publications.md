...
## working papers
1. [Wage cuts, Social Distributional Preferences, and Political Corruption](https://publications.iadb.org/en/wage-cuts-social-distributional-preferences-and-political-corruption-preliminary-results).
(with [Carlos Scartascini](https://www.cscartascini.org/))

2. [Corruption and Political Accountability in Good and Bad Economic Times](https://publications.iadb.org/en/corruption-and-political-accountability-good-and-bad-economic-times). 
(with [Carlos Scartascini](https://www.cscartascini.org/))(<i>Submitted</i>)

3. [Gradual or abrupt? How Tax Reform Design and Information Shape Compliance](https://publications.iadb.org/en/how-tax-reform-design-and-information-shape-compliance-preliminary-results).
